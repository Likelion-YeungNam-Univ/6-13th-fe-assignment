  ...
  return (
    ...
    <div className="flex space-x border-b border-gray-200 shadow-md px-24 h-24 justify-between ">
      ...
      <div className="flex items-center space-x-4">
        <div className="h-10 w-10 border-[1.5px] rounded-full flex items-center justify-center">
          <IoIosArrowForward className="h-5 w-5" />
        </div>
        <div className="flex items-center border-[1.5px] rounded-2xl h-16 w-24 p-3">
