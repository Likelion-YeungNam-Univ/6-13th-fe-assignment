...
const searchIcon =
  "https://img.icons8.com/?size=100&id=2sWrwEXiaegS&format=png&color=FFFFFF";
const world =
  "https://img.icons8.com/?size=100&id=BWuc2Bh5ht4f&format=png&color=000000";

function Header() {
  return (
    <div className="flex relative justify-between px-20 border-b py-4 border-gray-200 max-h-24">
      {/* Logo */}
      ...
      <div className="flex items-center space-x-4  mr-4">
        <div className="flex items-center hover:bg-gray-100 w-max h-14 px-4 rounded-full">
          당신의 공간을 에어비앤비하세요
        </div>
        <img
          src={world}
          className="hover:bg-gray-100 rounded-full w-12 h-12 p-3"
        />
